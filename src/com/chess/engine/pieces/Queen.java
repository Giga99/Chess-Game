...
public class Queen extends Piece {
    ...
    private static boolean isFirstColumnExclusion(final int currenPosition, final int candidateOffset){
        return BoardUtils.FIRST_COLUMN[currenPosition] && ((candidateOffset == -9) || (candidateOffset == -1) ||
                (candidateOffset == 7));
    }

    private static boolean isEightColumnExclusion(final int currenPosition, final int candidateOffset){
        return BoardUtils.EIGHT_COLUMN[currenPosition] && ((candidateOffset == -7) || (candidateOffset == 1) ||
                (candidateOffset == 9));
    }
}